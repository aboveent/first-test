...
file = pd.read_excel(r'E:\Cron-Jobs-E-DO-NOT-DELETE\BWW-Ad-Customizers\NFL Ad Customizers\Week ' + week + r'\Customizers 1\NFL Ad Customizers1 - Week ' + week + ' - Through ' + day_of_week + '.xlsx')
