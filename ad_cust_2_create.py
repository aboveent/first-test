...
file = pd.read_excel(r'E:\Cron-Jobs-E-DO-NOT-DELETE\BWW-Ad-Customizers\NFL Ad Customizers\Week ' + week + r'\Customizers 2\NFL Ad Customizers2 - Week ' + week + ' - Through ' + day_of_week + '.xlsx')
